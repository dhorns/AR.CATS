...
enum{ EI_npart, EI_dircos, EI_plab, EI_elab, EI_idpart, EI_vertex, EI_beam,
      ...
      EI_nmwpc, EI_imwpc, EI_mposx, EI_mposy, EI_mposz, EI_emwpc,
		EI_ncatscore, EI_icatscore, EI_ecatscore, EI_tcatscore,
		EI_ncatsann, EI_icatsann, EI_ecatsann, EI_tcatsann,
		EI_ncatsshield, EI_icatsshield, EI_ecatsshield, EI_tcatsshield,
