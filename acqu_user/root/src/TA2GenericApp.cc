...
enum { EGenDet, EGenericApp_CATSCore, EGenericApp_CATSAnnulus, EGenericApp_CATSShield, EPlasticPID, ELongScint, EFPMicro, EPairSpec };
static Map_t kValidDetectors[] = {
  {"TA2GenericDetector",EGenDet},
  {"TA2GenericApp_CATSCore",EGenericApp_CATSCore},
  {"TA2GenericApp_CATSAnnulus",EGenericApp_CATSAnnulus},
  {"TA2GenericApp_CATSShield",EGenericApp_CATSShield},
...
TA2DataManager*  TA2GenericApp::CreateChild(const char* name, Int_t dclass)
{
  ...
  case EGenDet:
    ...
    return fGenDet;
  case EGenericApp_CATSCore:
    fCATSCore = new TA2GenericApp_CATSCore(name, this);
    return fCATSCore;
  case EGenericApp_CATSAnnulus:
    fCATSAnnulus = new TA2GenericApp_CATSAnnulus(name, this);
    return fCATSAnnulus;
  case EGenericApp_CATSShield:
    fCATSShield = new TA2GenericApp_CATSShield(name, this);
    return fCATSShield;
  case ELongScint:
