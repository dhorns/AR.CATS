...
private:
	...
	TTree*       treeCats;           // CATS information
	...
	//CATS
        Int_t           nCATSCoreADCs;
	Int_t*          CATSCoreADCs;
        Int_t*          CATSCoreADCsRaw;
        Bool_t*         CATSCoreADCsHit;
        
        Int_t           nCATSCoreTDCs;
        Int_t*          CATSCoreTDCs;
        Int_t*          CATSCoreTDCsRaw;
        Bool_t*         CATSCoreTDCsHit;

        Int_t		nCATSCoreHits;
        Int_t*		CATSCoreHits;
        Int_t*		CATSCoreCluster;
        Double_t*       CATSCoreEnergy;
        Double_t*       CATSCoreTime;

        Int_t           nCATSAnnulusADCs;
	Int_t*          CATSAnnulusADCs;
        Int_t*          CATSAnnulusADCsRaw;
        Bool_t*         CATSAnnulusADCsHit;
        
        Int_t           nCATSAnnulusTDCs;
        Int_t*          CATSAnnulusTDCs;
        Int_t*          CATSAnnulusTDCsRaw;
        Bool_t*         CATSAnnulusTDCsHit;

        Int_t		nCATSAnnulusHits;
        Int_t*		CATSAnnulusHits;
        Int_t*		CATSAnnulusCluster;
        Double_t*       CATSAnnulusEnergy;
        Double_t*       CATSAnnulusTime;
        
        Int_t           nCATSShieldADCs;
	Int_t*          CATSShieldADCs;
        Int_t*          CATSShieldADCsRaw;
        Bool_t*         CATSShieldADCsHit;
        
        Int_t           nCATSShieldTDCs;
        Int_t*          CATSShieldTDCs;
        Int_t*          CATSShieldTDCsRaw;
        Bool_t*         CATSShieldTDCsHit;

        Int_t		nCATSShieldHits;
        Int_t*		CATSShieldHits;
        Int_t*		CATSShieldCluster;
        Double_t*       CATSShieldEnergy;
        Double_t*       CATSShieldTime;
...
//************* CATS *************
                ...
                TH1*           CATSCore_RawADC_PMT1;
                TH1*           CATSCore_RawADC_PMT2;
                TH1*           CATSCore_RawADC_PMT3;
                TH1*           CATSCore_RawADC_PMT4;
                TH1*           CATSCore_RawADC_PMT5;
                TH1*           CATSCore_RawADC_PMT6;
                TH1*           CATSCore_RawADC_PMT7;
                
                TH1*           CATSAnnulus_RawADC_segment1;
                TH1*           CATSAnnulus_RawADC_segment2;
                TH1*           CATSAnnulus_RawADC_segment3;
                TH1*           CATSAnnulus_RawADC_segment4;
                TH1*           CATSAnnulus_RawADC_segment5;
                TH1*           CATSAnnulus_RawADC_segment6;
                
                TH1*           CATSShield_RawADC_segment1;
                TH1*           CATSShield_RawADC_segment2;
                TH1*           CATSShield_RawADC_segment3;
                TH1*           CATSShield_RawADC_segment4;
                TH1*           CATSShield_RawADC_segment5;
                
                TH1*           CATSCore_NOshield_RawADC_PMT1;
                TH1*           CATSCore_NOshield_RawADC_PMT2;
                TH1*           CATSCore_NOshield_RawADC_PMT3;
                TH1*           CATSCore_NOshield_RawADC_PMT4;
                TH1*           CATSCore_NOshield_RawADC_PMT5;
                TH1*           CATSCore_NOshield_RawADC_PMT6;
                TH1*           CATSCore_NOshield_RawADC_PMT7;
                
                TH1*           CATSAnnulus_NOshield_RawADC_segment1;
                TH1*           CATSAnnulus_NOshield_RawADC_segment2;
                TH1*           CATSAnnulus_NOshield_RawADC_segment3;
                TH1*           CATSAnnulus_NOshield_RawADC_segment4;
                TH1*           CATSAnnulus_NOshield_RawADC_segment5;
                TH1*           CATSAnnulus_NOshield_RawADC_segment6;
                
                TH1*           CATSCore_energy_PMT1;
                TH1*           CATSCore_energy_PMT2;
                TH1*           CATSCore_energy_PMT3;
                TH1*           CATSCore_energy_PMT4;
                TH1*           CATSCore_energy_PMT5;
                TH1*           CATSCore_energy_PMT6;
                TH1*           CATSCore_energy_PMT7;
                
                TH1*           CATSAnnulus_energy_segment1;
                TH1*           CATSAnnulus_energy_segment2;
                TH1*           CATSAnnulus_energy_segment3;
                TH1*           CATSAnnulus_energy_segment4;
                TH1*           CATSAnnulus_energy_segment5;
                TH1*           CATSAnnulus_energy_segment6;
                
                TH1*           CATSShield_energy_segment1;
                TH1*           CATSShield_energy_segment2;
                TH1*           CATSShield_energy_segment3;
                TH1*           CATSShield_energy_segment4;
                TH1*           CATSShield_energy_segment5;
                
                TH1*           CATSCore_energySum;
...
// End of new stuff
	...
	protected:    	
    	...
    	void WriteHistograms();         // Write histograms
