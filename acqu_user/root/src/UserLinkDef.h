...
// Physics classes
#pragma link C++ class TA2CATSPhysics+;
...
#pragma link C++ class TA2GenericApp_CATSCore++;
#pragma link C++ class TA2GenericApp_CATSAnnulus+;
#pragma link C++ class TA2GenericApp_CATSShield+;
