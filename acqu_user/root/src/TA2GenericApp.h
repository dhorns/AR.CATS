...
#include "TA2GenericApp_CATSCore.h"    // CATS
#include "TA2GenericApp_CATSAnnulus.h" // CATS
#include "TA2GenericApp_CATSShield.h"  // CATS
...
protected:
  ...
  TA2Detector* fCATSCore;                  // CATS
  TA2Detector* fCATSAnnulus;               // CATS
  TA2Detector* fCATSShield;                // CATS
...
public:
  ...
  TA2Detector* GetCATSCore(){ return fCATSCore; } // CATS
  TA2Detector* GetCATSAnnulus(){ return fCATSAnnulus; } // CATS
  TA2Detector* GetCATSShield(){ return fCATSShield; } // CATS
  ...
  ClassDef(TA2GenericApp,1)//Micha: so war es vorher
//  ClassDef(TA2GenericApp,2)//so ist es in TA2Taps.h
};
