...
TA2GenericApp_CATSShield::TA2GenericApp_CATSShield(const char* name, TA2System* apparatus)
...
TA2GenericApp_CATSShield::~TA2GenericApp_CATSShield()
//2TAPS_BaF2::~TA2TAPS_BaF2()// Vergleich TAPS-BaFs
{  
    DeleteArrays();
}

void TA2GenericApp_CATSShield::LoadVariable()
{
...
void TA2GenericApp_CATSShield::SaveDecoded()
{
  // Save decoded info to Root Tree file
}

void TA2GenericApp_CATSShield::SetConfig(Char_t* line, Int_t key)
{
...
ClassImp(TA2GenericApp_CATSShield)
