...
TA2GoAT::TA2GoAT(const char* Name, TA2Analysis* Analysis) : TA2AccessSQL(Name, Analysis),
							            ...
							            CATSCoreTDCsHit(0),
                                                                    ...
                                                                    nCATSAnnulusADCs(0),
							            CATSAnnulusADCs(0),
							            CATSAnnulusADCsHit(0),
							            CATSAnnulusADCsRaw(0),
							            CATSAnnulusTDCsHit(0),
                                                                    nCATSAnnulusHits(0),
                                                                    CATSAnnulusHits(0),
                                                                    CATSAnnulusCluster(0),
                                                                    CATSAnnulusEnergy(0),
                                                                    CATSAnnulusTime(0),
                                                                    nCATSShieldADCs(0),
							            CATSShieldADCs(0),
...
//    Char_t tmp[256];
    ...
    CATSCoreADCs     = new Int_t[TA2GoAT_MAX_HITS];
    CATSCoreADCsRaw  = new Int_t[7];
    CATSCoreADCsHit  = new Bool_t[TA2GoAT_MAX_HITS];
    CATSCoreTDCs     = new Int_t[TA2GoAT_MAX_HITS];
    CATSCoreTDCsRaw  = new Int_t[7];
    CATSCoreTDCsHit  = new Bool_t[TA2GoAT_MAX_HITS];
    CATSCoreHits     = new Int_t[TA2GoAT_MAX_HITS];
    CATSCoreCluster  = new Int_t[TA2GoAT_MAX_HITS];
    CATSCoreEnergy   = new Double_t[TA2GoAT_MAX_HITS];
    CATSCoreTime     = new Double_t[TA2GoAT_MAX_HITS];
    CATSAnnulusADCs     = new Int_t[TA2GoAT_MAX_HITS];
    CATSAnnulusADCsRaw  = new Int_t[6];
    CATSAnnulusADCsHit  = new Bool_t[TA2GoAT_MAX_HITS];
    CATSAnnulusTDCs     = new Int_t[TA2GoAT_MAX_HITS];
    CATSAnnulusTDCsRaw  = new Int_t[6];
    CATSAnnulusTDCsHit  = new Bool_t[TA2GoAT_MAX_HITS];
    CATSAnnulusHits     = new Int_t[TA2GoAT_MAX_HITS];
    CATSAnnulusCluster  = new Int_t[TA2GoAT_MAX_HITS];
    CATSAnnulusEnergy   = new Double_t[TA2GoAT_MAX_HITS];
    CATSAnnulusTime     = new Double_t[TA2GoAT_MAX_HITS];
    CATSShieldADCs     = new Int_t[TA2GoAT_MAX_HITS];
    CATSShieldADCsRaw  = new Int_t[5];
    CATSShieldADCsHit  = new Bool_t[TA2GoAT_MAX_HITS];
    CATSShieldTDCs     = new Int_t[TA2GoAT_MAX_HITS];
    CATSShieldTDCsRaw  = new Int_t[5];
    CATSShieldTDCsHit  = new Bool_t[TA2GoAT_MAX_HITS];
    CATSShieldHits     = new Int_t[TA2GoAT_MAX_HITS];
    CATSShieldCluster  = new Int_t[TA2GoAT_MAX_HITS];
    CATSShieldEnergy   = new Double_t[TA2GoAT_MAX_HITS];
    CATSShieldTime     = new Double_t[TA2GoAT_MAX_HITS];
    ...
    if(fCATSCore)
    {
        ...
        {
            treeCats->Branch("nCATSCoreADCs", &nCATSCoreADCs, "nCATSCoreADCs/I");
            treeCats->Branch("CATSCoreADCs", CATSCoreADCs, "CATSCoreADCs[nCATSCoreADCs]/I");
            treeCats->Branch("CATSCoreADCsRaw", CATSCoreADCsRaw, "CATSCoreADCsRaw[7]/I");
            treeCats->Branch("CATSCoreADCsHit", CATSCoreADCsHit, "CATSCoreADCsHit[nCATSCoreADCs]/O");
            treeCats->Branch("nCATSCoreTDCs", &nCATSCoreTDCs, "nCATSCoreTDCs/I");
            treeCats->Branch("CATSCoreTDCs", CATSCoreTDCs, "CATSCoreTDCs[nCATSCoreTDCs]/I");
            treeCats->Branch("CATSCoreTDCsRaw", CATSCoreTDCsRaw, "CATSCoreTDCsRaw[7]/I");
            treeCats->Branch("CATSCoreTDCsHit", CATSCoreTDCsHit, "CATSCoreTDCsHit[nCATSCoreTDCs]/O");
        }
        treeCats->Branch("nCATSCoreHits", &nCATSCoreHits, "nCATSCoreHits/I");
        treeCats->Branch("CATSCoreHits", CATSCoreHits, "CATSCoreHits[nCATSCoreHits]/I");

        if (fCATSCore->IsEnergy()) 
        {
            treeCats->Branch("CATSCoreEnergy", CATSCoreEnergy, "CATSCoreEnergy[nCATSCoreHits]/D");
        }
        
        if(fCATSCore->IsTime()) 
        {
            treeCats->Branch("CATSCoreTime", CATSCoreTime, "CATSCoreTime[nCATSCoreHits]/D");
        }
    }
    ...
    if(fCATSAnnulus)
    {
        ...
        {
            treeCats->Branch("nCATSAnnulusADCs", &nCATSAnnulusADCs, "nCATSAnnulusADCs/I");
            treeCats->Branch("CATSAnnulusADCs", CATSAnnulusADCs, "CATSAnnulusADCs[nCATSAnnulusADCs]/I");
            treeCats->Branch("CATSAnnulusADCsRaw", CATSAnnulusADCsRaw, "CATSAnnulusADCsRaw[6]/I");
            treeCats->Branch("CATSAnnulusADCsHit", CATSAnnulusADCsHit, "CATSAnnulusADCsHit[nCATSAnnulusADCs]/O");
            treeCats->Branch("nCATSAnnulusTDCs", &nCATSAnnulusTDCs, "nCATSAnnulusTDCs/I");
            treeCats->Branch("CATSAnnulusTDCs", CATSAnnulusTDCs, "CATSAnnulusTDCs[nCATSAnnulusTDCs]/I");
            treeCats->Branch("CATSAnnulusTDCsRaw", CATSAnnulusTDCsRaw, "CATSAnnulusTDCsRaw[6]/I");
            treeCats->Branch("CATSAnnulusTDCsHit", CATSAnnulusTDCsHit, "CATSAnnulusTDCsHit[nCATSAnnulusTDCs]/O");
        }
        treeCats->Branch("nCATSAnnulusHits", &nCATSAnnulusHits, "nCATSAnnulusHits/I");
        treeCats->Branch("CATSAnnulusHits", CATSAnnulusHits, "CATSAnnulusHits[nCATSAnnulusHits]/I");

        if (fCATSAnnulus->IsEnergy()) 
        {
            treeCats->Branch("CATSAnnulusEnergy", CATSAnnulusEnergy, "CATSAnnulusEnergy[nCATSAnnulusHits]/D");
        }
        
        if(fCATSAnnulus->IsTime()) 
        {
            treeCats->Branch("CATSAnnulusTime", CATSAnnulusTime, "CATSAnnulusTime[nCATSAnnulusHits]/D");
        }
    } 
    ...
    if(fCATSShield)
    {
        ...
        {
            treeCats->Branch("nCATSShieldADCs", &nCATSShieldADCs, "nCATSShieldADCs/I");
            treeCats->Branch("CATSShieldADCs", CATSShieldADCs, "CATSCoreADCs[nCATSShieldADCs]/I");
            treeCats->Branch("CATSShieldADCsRaw", CATSShieldADCsRaw, "CATSShieldADCsRaw[5]/I");
            treeCats->Branch("CATSShieldADCsHit", CATSShieldADCsHit, "CATSShieldADCsHit[nCATSShieldADCs]/O");
            treeCats->Branch("nCATSShieldTDCs", &nCATSShieldTDCs, "nCATSShieldTDCs/I");
            treeCats->Branch("CATSShieldTDCs", CATSShieldTDCs, "CATSShieldTDCs[nCATSShieldTDCs]/I");
            treeCats->Branch("CATSShieldTDCsRaw", CATSShieldTDCsRaw, "CATSShieldTDCsRaw[5]/I");
            treeCats->Branch("CATSShieldTDCsHit", CATSShieldTDCsHit, "CATSShieldTDCsHit[nCATSShieldTDCs]/O");
        }
        treeCats->Branch("nCATSShieldHits", &nCATSShieldHits, "nCATSShieldHits/I");
        treeCats->Branch("CATSShieldHits", CATSShieldHits, "CATSShieldHits[nCATSShieldHits]/I");

        if (fCATSShield->IsEnergy()) 
        {
            treeCats->Branch("CATSShieldEnergy", CATSShieldEnergy, "CATSShieldEnergy[nCATSShieldHits]/D");
        }
        
        if(fCATSShield->IsTime()) 
        {
            treeCats->Branch("CATSShieldTime", CATSShieldTime, "CATSShieldTime[nCATSShieldHits]/D");
        }
    }
    ...
    Int_t nCATSCore;
    Double_t CATSCoreGlobalScale;
    Double_t* CATSCoreADCGain;

    
    if(fCATSCore)
    {
        nCATSCore = fCATSCore->GetNelem(); 
        CATSCoreGlobalScale = fCATSCore->GetEnergyScale();
    
        CATSCoreADCGain = new Double_t[nCATSCore];
    
        for(UInt_t i=0; i<fCATSCore->GetNelem(); i++)
        {
            CATSCoreADCGain[i] = fCATSCore->GetElement(i)->GetA1();
        }
        treeSetupParameters->Branch("nCATSCore", &nCATSCore, "nCATSCore/I");
        treeSetupParameters->Branch("CATSCoreGlobalScale", &CATSCoreGlobalScale, "CATSCoreGlobalScale/D");
        treeSetupParameters->Branch("CATSCoreADCGain", CATSCoreADCGain, "CATSCoreADCGain[nCATSCore]/D");
    }
...
void    TA2GoAT::Reconstruct()
{
	...
	if(fCATSCore)
        {
            if (fCATSCore->IsRawHits())
            {
                ...
                for(Int_t i=0; i<7; i++) CATSCoreADCsRaw[i] = 0;
                for(Int_t i=0; i<nCATSCoreADCs; i++)
                {
                ...
                for(Int_t i=0; i<7; i++) CATSCoreTDCsRaw[i] = 0;
                for(Int_t i=0; i<nCATSCoreTDCs; i++)
                {
            ...
            for(Int_t i=0; i<nCATSCoreHits; i++)
            {
        ...
        if(fCATSAnnulus)
        {
            if (fCATSAnnulus->IsRawHits())
            {
                ...
                for(Int_t i=0; i<6; i++) CATSAnnulusADCsRaw[i] = 0;
                for(Int_t i=0; i<nCATSAnnulusADCs; i++)
                {
                ...
                for(Int_t i=0; i<6; i++) CATSAnnulusTDCsRaw[i] = 0;
                for(Int_t i=0; i<nCATSAnnulusTDCs; i++)
                {
            ...
            for(Int_t i=0; i<nCATSAnnulusHits; i++)
            {
        ...
        if(fCATSShield)
        {
            if (fCATSShield->IsRawHits())
            {
                ...
                for(Int_t i=0; i<7; i++) CATSShieldADCsRaw[i] = 0;
                for(Int_t i=0; i<nCATSShieldADCs; i++)
                {
                ...
                for(Int_t i=0; i<7; i++) CATSShieldTDCsRaw[i] = 0;
                for(Int_t i=0; i<nCATSShieldTDCs; i++)
                {
            ...
            for(Int_t i=0; i<nCATSShieldHits; i++)
            {
    ...
    CATSCoreADCs[nCATSCoreADCs]     = EBufferEnd;
    CATSCoreADCsHit[nCATSCoreADCs]  = EBufferEnd;
    CATSAnnulusADCs[nCATSAnnulusADCs]     = EBufferEnd;
    CATSAnnulusADCsHit[nCATSAnnulusADCs]  = EBufferEnd;
    CATSShieldADCs[nCATSShieldADCs]     = EBufferEnd;
    CATSShieldADCsHit[nCATSShieldADCs]  = EBufferEnd;
...
//    Char_t tmp[256];
	...
	Check_VetoTDCHits 	= new TH2F("Check_VetoTDCHits", "Veto TDC Hits by event number",10000,  0,  10000000, 438, 0, 438);
        ...
        CATSCore_RawADC_PMT1 = new TH1F("CATSCore_RawADC_PMT1", "CATSCore_RawADC_PMT1", 4096, 0, 4096);
        CATSCore_RawADC_PMT2 = new TH1F("CATSCore_RawADC_PMT2", "CATSCore_RawADC_PMT2", 4096, 0, 4096);
        CATSCore_RawADC_PMT3 = new TH1F("CATSCore_RawADC_PMT3", "CATSCore_RawADC_PMT3", 4096, 0, 4096);
        CATSCore_RawADC_PMT4 = new TH1F("CATSCore_RawADC_PMT4", "CATSCore_RawADC_PMT4", 4096, 0, 4096);
        CATSCore_RawADC_PMT5 = new TH1F("CATSCore_RawADC_PMT5", "CATSCore_RawADC_PMT5", 4096, 0, 4096);
        CATSCore_RawADC_PMT6 = new TH1F("CATSCore_RawADC_PMT6", "CATSCore_RawADC_PMT6", 4096, 0, 4096);
        CATSCore_RawADC_PMT7 = new TH1F("CATSCore_RawADC_PMT7", "CATSCore_RawADC_PMT7", 4096, 0, 4096);
        
        CATSAnnulus_RawADC_segment1 = new TH1F("CATSAnnulus_RawADC_segment1", "CATSAnnulus_RawADC_segment1", 4096, 0, 4096);
        CATSAnnulus_RawADC_segment2 = new TH1F("CATSAnnulus_RawADC_segment2", "CATSAnnulus_RawADC_segment2", 4096, 0, 4096);
        CATSAnnulus_RawADC_segment3 = new TH1F("CATSAnnulus_RawADC_segment3", "CATSAnnulus_RawADC_segment3", 4096, 0, 4096);
        CATSAnnulus_RawADC_segment4 = new TH1F("CATSAnnulus_RawADC_segment4", "CATSAnnulus_RawADC_segment4", 4096, 0, 4096);
        CATSAnnulus_RawADC_segment5 = new TH1F("CATSAnnulus_RawADC_segment5", "CATSAnnulus_RawADC_segment5", 4096, 0, 4096);
        CATSAnnulus_RawADC_segment6 = new TH1F("CATSAnnulus_RawADC_segment6", "CATSAnnulus_RawADC_segment6", 4096, 0, 4096);
        
        CATSShield_RawADC_segment1 = new TH1F("CATSShield_RawADC_segment1", "CATSShield_RawADC_segment1", 4096, 0, 4096);
        CATSShield_RawADC_segment2 = new TH1F("CATSShield_RawADC_segment2", "CATSShield_RawADC_segment2", 4096, 0, 4096);
        CATSShield_RawADC_segment3 = new TH1F("CATSShield_RawADC_segment3", "CATSShield_RawADC_segment3", 4096, 0, 4096);
        CATSShield_RawADC_segment4 = new TH1F("CATSShield_RawADC_segment4", "CATSShield_RawADC_segment4", 4096, 0, 4096);
        CATSShield_RawADC_segment5 = new TH1F("CATSShield_RawADC_segment5", "CATSShield_RawADC_segment5", 4096, 0, 4096);        
 
        CATSCore_NOshield_RawADC_PMT1 = new TH1F("CATSCore_NOshield_RawADC_PMT1", "CATSCore_NOshield_RawADC_PMT1", 4096, 0, 4096);
        CATSCore_NOshield_RawADC_PMT2 = new TH1F("CATSCore_NOshield_RawADC_PMT2", "CATSCore_NOshield_RawADC_PMT2", 4096, 0, 4096);
        CATSCore_NOshield_RawADC_PMT3 = new TH1F("CATSCore_NOshield_RawADC_PMT3", "CATSCore_NOshield_RawADC_PMT3", 4096, 0, 4096);
        CATSCore_NOshield_RawADC_PMT4 = new TH1F("CATSCore_NOshield_RawADC_PMT4", "CATSCore_NOshield_RawADC_PMT4", 4096, 0, 4096);
        CATSCore_NOshield_RawADC_PMT5 = new TH1F("CATSCore_NOshield_RawADC_PMT5", "CATSCore_NOshield_RawADC_PMT5", 4096, 0, 4096);
        CATSCore_NOshield_RawADC_PMT6 = new TH1F("CATSCore_NOshield_RawADC_PMT6", "CATSCore_NOshield_RawADC_PMT6", 4096, 0, 4096);
        CATSCore_NOshield_RawADC_PMT7 = new TH1F("CATSCore_NOshield_RawADC_PMT7", "CATSCore_NOshield_RawADC_PMT7", 4096, 0, 4096);
 
        CATSAnnulus_NOshield_RawADC_segment1 = new TH1F("CATSAnnulus_NOshield_RawADC_segment1", "CATSAnnulus_NOshield_RawADC_segment1", 4096, 0, 4096);
        CATSAnnulus_NOshield_RawADC_segment2 = new TH1F("CATSAnnulus_NOshield_RawADC_segment2", "CATSAnnulus_NOshield_RawADC_segment2", 4096, 0, 4096);
        CATSAnnulus_NOshield_RawADC_segment3 = new TH1F("CATSAnnulus_NOshield_RawADC_segment3", "CATSAnnulus_NOshield_RawADC_segment3", 4096, 0, 4096);
        CATSAnnulus_NOshield_RawADC_segment4 = new TH1F("CATSAnnulus_NOshield_RawADC_segment4", "CATSAnnulus_NOshield_RawADC_segment4", 4096, 0, 4096);
        CATSAnnulus_NOshield_RawADC_segment5 = new TH1F("CATSAnnulus_NOshield_RawADC_segment5", "CATSAnnulus_NOshield_RawADC_segment5", 4096, 0, 4096);
        CATSAnnulus_NOshield_RawADC_segment6 = new TH1F("CATSAnnulus_NOshield_RawADC_segment6", "CATSAnnulus_NOshield_RawADC_segment6", 4096, 0, 4096);
  
        CATSCore_energy_PMT1 = new TH1F("CATSCore_energy_PMT1", "CATSCore_energy_PMT1", 800, 0, 800);
        CATSCore_energy_PMT2 = new TH1F("CATSCore_energy_PMT2", "CATSCore_energy_PMT2", 800, 0, 800);
        CATSCore_energy_PMT3 = new TH1F("CATSCore_energy_PMT3", "CATSCore_energy_PMT3", 800, 0, 800);
        CATSCore_energy_PMT4 = new TH1F("CATSCore_energy_PMT4", "CATSCore_energy_PMT4", 800, 0, 800);
        CATSCore_energy_PMT5 = new TH1F("CATSCore_energy_PMT5", "CATSCore_energy_PMT5", 800, 0, 800);
        CATSCore_energy_PMT6 = new TH1F("CATSCore_energy_PMT6", "CATSCore_energy_PMT6", 800, 0, 800);
        CATSCore_energy_PMT7 = new TH1F("CATSCore_energy_PMT7", "CATSCore_energy_PMT7", 800, 0, 800);
        
        CATSAnnulus_energy_segment1 = new TH1F("CATSAnnulus_energy_segment1", "CATSAnnulus_energy_segment1", 500, 0, 50);
        CATSAnnulus_energy_segment2 = new TH1F("CATSAnnulus_energy_segment2", "CATSAnnulus_energy_segmetn2", 500, 0, 50);
        CATSAnnulus_energy_segment3 = new TH1F("CATSAnnulus_energy_segment3", "CATSAnnulus_energy_segment3", 500, 0, 50);
        CATSAnnulus_energy_segment4 = new TH1F("CATSAnnulus_energy_segment4", "CATSAnnulus_energy_segment4", 500, 0, 50);
        CATSAnnulus_energy_segment5 = new TH1F("CATSAnnulus_energy_segment5", "CATSAnnulus_energy_segment5", 500, 0, 50);
        CATSAnnulus_energy_segment6 = new TH1F("CATSAnnulus_energy_segment6", "CATSAnnulus_energy_segment6", 500, 0, 50);
        
        CATSShield_energy_segment1 = new TH1F("CATSShield_energy_segment1", "CATSShield_energy_segment1", 1000, 0, 200);
        CATSShield_energy_segment2 = new TH1F("CATSShield_energy_segment2", "CATSShield_energy_segment2", 1000, 0, 200);
        CATSShield_energy_segment3 = new TH1F("CATSShield_energy_segment3", "CATSShield_energy_segment3", 1000, 0, 200);
        CATSShield_energy_segment4 = new TH1F("CATSShield_energy_segment4", "CATSShield_energy_segment4", 1000, 0, 200);
        CATSShield_energy_segment5 = new TH1F("CATSShield_energy_segment5", "CATSShield_energy_segment5", 1000, 0, 200);
        
        CATSCore_energySum = new TH1F("CATSCore_energySum", "CATSCore_energySum", 800, 0, 800);


// New stuff for Laura
        Tagger_v_CATS1 = new TH2F( "Tagger_v_CATS1", "Tagger_v_CATS1", 352, 0, 352, 800, 0, 800);
        Tagger_v_CATS2 = new TH2F( "Tagger_v_CATS2", "Tagger_v_CATS2", 352, 0, 352, 800, 0, 800);
        Tagger_v_CATS3 = new TH2F( "Tagger_v_CATS3", "Tagger_v_CATS3", 352, 0, 352, 800, 0, 800);
        Tagger_v_CATS4 = new TH2F( "Tagger_v_CATS4", "Tagger_v_CATS4", 352, 0, 352, 800, 0, 800);
        Tagger_v_CATS5 = new TH2F( "Tagger_v_CATS5", "Tagger_v_CATS5", 352, 0, 352, 800, 0, 800);
        Tagger_v_CATS6 = new TH2F( "Tagger_v_CATS6", "Tagger_v_CATS6", 352, 0, 352, 800, 0, 800);
        Tagger_v_CATS7 = new TH2F( "Tagger_v_CATS7", "Tagger_v_CATS7", 352, 0, 352, 800, 0, 800);
// End of new stuff		  
...
void	TA2GoAT::WriteHistograms()
{
	// Write check histograms
        ...
        file->mkdir("CATSCore");
        file->cd("CATSCore");
        CATSCore_RawADC_PMT1->Write();
        CATSCore_RawADC_PMT2->Write();
        CATSCore_RawADC_PMT3->Write();
        CATSCore_RawADC_PMT4->Write();
        CATSCore_RawADC_PMT5->Write();
        CATSCore_RawADC_PMT6->Write();
        CATSCore_RawADC_PMT7->Write();
        CATSCore_energy_PMT1->Write();
        CATSCore_energy_PMT2->Write();
        CATSCore_energy_PMT3->Write();
        CATSCore_energy_PMT4->Write();
        CATSCore_energy_PMT5->Write();
        CATSCore_energy_PMT6->Write();
        CATSCore_energy_PMT7->Write();
        CATSCore_energySum->Write();
        file->cd();
    
        file->mkdir("CATSAnnulus");
        file->cd("CATSAnnulus");
        CATSAnnulus_RawADC_segment1->Write();
        CATSAnnulus_RawADC_segment2->Write();
        CATSAnnulus_RawADC_segment3->Write();
        CATSAnnulus_RawADC_segment4->Write();
        CATSAnnulus_RawADC_segment5->Write();
        CATSAnnulus_RawADC_segment6->Write();
        CATSAnnulus_energy_segment1->Write();
        CATSAnnulus_energy_segment2->Write();
        CATSAnnulus_energy_segment3->Write();
        CATSAnnulus_energy_segment4->Write();
        CATSAnnulus_energy_segment5->Write();
        CATSAnnulus_energy_segment6->Write();
        file->cd();
        
        file->mkdir("CATSShield");
        file->cd("CATSShield");
        CATSShield_RawADC_segment1->Write();
        CATSShield_RawADC_segment2->Write();
        CATSShield_RawADC_segment3->Write();
        CATSShield_RawADC_segment4->Write();
        CATSShield_RawADC_segment5->Write();
        CATSShield_energy_segment1->Write();
        CATSShield_energy_segment2->Write();
        CATSShield_energy_segment3->Write();
        CATSShield_energy_segment4->Write();
        CATSShield_energy_segment5->Write();
        file->cd();
        
        file->mkdir("CATScuts");
        file->cd("CATScuts");
        CATSCore_NOshield_RawADC_PMT1->Write();
        CATSCore_NOshield_RawADC_PMT2->Write();
        CATSCore_NOshield_RawADC_PMT3->Write();
        CATSCore_NOshield_RawADC_PMT4->Write();
        CATSCore_NOshield_RawADC_PMT5->Write();
        CATSCore_NOshield_RawADC_PMT6->Write();
        CATSCore_NOshield_RawADC_PMT7->Write();
        CATSAnnulus_NOshield_RawADC_segment1->Write();
        CATSAnnulus_NOshield_RawADC_segment2->Write();
        CATSAnnulus_NOshield_RawADC_segment3->Write();
        CATSAnnulus_NOshield_RawADC_segment4->Write();
        CATSAnnulus_NOshield_RawADC_segment5->Write();
        CATSAnnulus_NOshield_RawADC_segment6->Write();
        file->cd();

// New stuff for Laura
			file->mkdir( "NewChecks");
			file->cd( "NewChecks");
			Tagger_v_CATS1->Write(); 
			Tagger_v_CATS2->Write(); 
			Tagger_v_CATS3->Write(); 
			Tagger_v_CATS4->Write(); 
			Tagger_v_CATS5->Write(); 
			Tagger_v_CATS6->Write(); 
			Tagger_v_CATS7->Write(); 
			file->cd();
// End of new stuff
	...
	if(fCATSCore)
        {
            if (fCATSCore->IsRawHits())
            {
                for (UInt_t i=0; i<fCATSCore->GetNADChits(); i++)
                {
                // get element number
                    Int_t elem = fCATSCore->GetRawEnergyHits()[i];
                // get ADC value
                    UShort_t value_adc = fCATSCore->GetElement(elem)->GetRawADCValue();
                // fill uncut ADC hits
                    if (elem == 0)
                    {
                        CATSCore_RawADC_PMT1->Fill(value_adc);
                    }
                    if (elem == 1)
                    {
                        CATSCore_RawADC_PMT2->Fill(value_adc);
                    }
                    if (elem == 2)
                    {
                        CATSCore_RawADC_PMT3->Fill(value_adc);
                    }
                    if (elem == 3)
                    {
                        CATSCore_RawADC_PMT4->Fill(value_adc);
                    }
                    if (elem == 4)
                    {
                        CATSCore_RawADC_PMT5->Fill(value_adc);
                    }
                    if (elem == 5)
                    {
                        CATSCore_RawADC_PMT6->Fill(value_adc);
                    }
                    if (elem == 6)
                    {
                        CATSCore_RawADC_PMT7->Fill(value_adc);
                    }
/*
                    if ((elem ==0) && (fCATSCore->IsEnergy()))
                    {
                        CATSCore_energy_PMT1->Fill(value_energy);
                    }
*/
                }
            }
            for(Int_t i=0; i<fCATSCore->GetNADChits(); i++)
            {
//                Int_t elem = fCATSCore->GetHits()[i];// =ADC + TDC -> wenn kein TDC-signal wird Histo nicht gefuellt
                Int_t elem = fCATSCore->GetRawEnergyHits()[i];
                if(fCATSCore->IsEnergy()) 
                {
//                    CATSCoreEnergy[i] = fCATSCore->GetEnergy(CATSCoreHits[i]); // verschiedene Spielereien
//                    UShort_t value_energy = fCATSCore->GetEnergy(); // verschiedene Spielereien
                    Double_t value_energy = fCATSCore->GetElement(elem)->GetEnergy();
                    CATSCore_energySum->Fill(value_energy);
                    if (elem == 0)
                    {
                        CATSCore_energy_PMT1->Fill(value_energy);
...
// New stuff for Laura
								if ( fTagger && fLadder)
								{
									...
									if ( fNmult <= 1 )
									{
										...
										for(Int_t i=0; i<nTagged; i++)
										{
											tagchan = (fLadder->GetHitsAll())[i];
											Tagger_v_CATS1->Fill( tagchan, value_energy);
										}
									}
									else
									{
...
// End of new stuff
                    ...
                    if (elem == 1)
                    {
                        CATSCore_energy_PMT2->Fill(value_energy);
// New stuff for Laura
								if ( fTagger && fLadder)
								{
									Int_t fNmult = 1;
									...
									if ( fNmult <= 1 )
									{
										...
										{
											tagchan = (fLadder->GetHitsAll())[i];
											Tagger_v_CATS2->Fill( tagchan, value_energy);
										}
									}
									else
									{
...
// End of new stuff
                    ...
                    if (elem == 2)
                    {
                        CATSCore_energy_PMT3->Fill(value_energy);
// New stuff for Laura
								if ( fTagger && fLadder)
								{
									Int_t fNmult = 1;
									...
									if ( fNmult <= 1 )
									{
										...
										{
											tagchan = (fLadder->GetHitsAll())[i];
											Tagger_v_CATS3->Fill( tagchan, value_energy);
										}
									}
									else
									{
...
// End of new stuff
                    ...
                    if (elem == 3)
                    {
                        CATSCore_energy_PMT4->Fill(value_energy);
// New stuff for Laura
								if ( fTagger && fLadder)
								{
									Int_t fNmult = 1;
									...
									if ( fNmult <= 1 )
									{
										...
										{
											tagchan = (fLadder->GetHitsAll())[i];
											Tagger_v_CATS4->Fill( tagchan, value_energy);
										}
									}
									else
									{
...
// End of new stuff
                    ...
                    if (elem == 4)
                    {
                        CATSCore_energy_PMT5->Fill(value_energy);
// New stuff for Laura
								if ( fTagger && fLadder)
								{
									Int_t fNmult = 1;
									...
									if ( fNmult <= 1 )
									{
										...
										{
											tagchan = (fLadder->GetHitsAll())[i];
											Tagger_v_CATS5->Fill( tagchan, value_energy);
										}
									}
									else
									{
...
// End of new stuff
                    ...
                    if (elem == 5)
                    {
                        CATSCore_energy_PMT6->Fill(value_energy);
// New stuff for Laura
								if ( fTagger && fLadder)
								{
									Int_t fNmult = 1;
									...
									if ( fNmult <= 1 )
									{
										...
										{
											tagchan = (fLadder->GetHitsAll())[i];
											Tagger_v_CATS6->Fill( tagchan, value_energy);
										}
									}
									else
									{
...
// End of new stuff
                    ...
                    if (elem == 6)
                    {
                        CATSCore_energy_PMT7->Fill(value_energy);
// New stuff for Laura
								if ( fTagger && fLadder)
								{
									Int_t fNmult = 1;
									...
									if ( fNmult <= 1 )
									{
										...
										{
											tagchan = (fLadder->GetHitsAll())[i];
											Tagger_v_CATS7->Fill( tagchan, value_energy);
										}
									}
									else
									{
	...
	if(fCATSAnnulus)
        {
            if (fCATSAnnulus->IsRawHits())
            {
                for (UInt_t i=0; i<fCATSAnnulus->GetNADChits(); i++)
                {
                // get element number
                    Int_t elem = fCATSAnnulus->GetRawEnergyHits()[i];
                // get ADC value
                    Double_t value_adc = fCATSAnnulus->GetElement(elem)->GetRawADCValue();
//                    UShort_t value_energy = fCATSAnnulus->GetElement(elem)->GetEnergy();
                // fill uncut ADC hits
                    if (elem == 0)
                    {
                        CATSAnnulus_RawADC_segment1->Fill(value_adc);
                    }
                    if (elem == 1)
                    {
                        CATSAnnulus_RawADC_segment2->Fill(value_adc);
                    }
                    if (elem == 2)
                    {
                        CATSAnnulus_RawADC_segment3->Fill(value_adc);
                    }
                    if (elem == 3)
                    {
                        CATSAnnulus_RawADC_segment4->Fill(value_adc);
                    }
                    if (elem == 4)
                    {
                        CATSAnnulus_RawADC_segment5->Fill(value_adc);
                    }
                    if (elem == 5)
                    {
                        CATSAnnulus_RawADC_segment6->Fill(value_adc);
                    }
                }
            }
            for(Int_t i=0; i<fCATSAnnulus->GetNADChits(); i++)
            {
                Int_t elem = fCATSAnnulus->GetRawEnergyHits()[i];
                if(fCATSAnnulus->IsEnergy()) 
                {
                    Double_t value_energy = fCATSAnnulus->GetElement(elem)->GetEnergy();
                    if (elem == 0)
                    {
                        CATSAnnulus_energy_segment1->Fill(value_energy);
                    }
                    if (elem == 1)
                    {
                        CATSAnnulus_energy_segment2->Fill(value_energy);
                    }
                    if (elem == 2)
                    {
                        CATSAnnulus_energy_segment3->Fill(value_energy);
                    }
                    if (elem == 3)
                    {
                        CATSAnnulus_energy_segment4->Fill(value_energy);
                    }
                    if (elem == 4)
                    {
                        CATSAnnulus_energy_segment5->Fill(value_energy);
                    }
                    if (elem == 5)
                    {
                        CATSAnnulus_energy_segment6->Fill(value_energy);
                    }
        ...
        if(fCATSShield)
        {
            if (fCATSShield->IsRawHits())
            {
                for (UInt_t i=0; i<fCATSShield->GetNADChits(); i++)
                {
                // get element number
                    Int_t elem = fCATSShield->GetRawEnergyHits()[i];
                // get ADC value
                    Double_t value_adc = fCATSShield->GetElement(elem)->GetRawADCValue();
                // fill uncut ADC hits
                    if (elem == 0)
                    {
                        CATSShield_RawADC_segment1->Fill(value_adc);
                    }
                    if (elem == 1)
                    {
                        CATSShield_RawADC_segment2->Fill(value_adc);
                    }
                    if (elem == 2)
                    {
                        CATSShield_RawADC_segment3->Fill(value_adc);
                    }
                    if (elem == 3)
                    {
                        CATSShield_RawADC_segment4->Fill(value_adc);
                    }
                    if (elem == 4)
                    {
                        CATSShield_RawADC_segment5->Fill(value_adc);
                    }
                }
            }
            for(Int_t i=0; i<fCATSShield->GetNADChits(); i++)
            {
                Int_t elem = fCATSShield->GetRawEnergyHits()[i];
                if(fCATSShield->IsEnergy()) 
                {
                    Double_t value_energy = fCATSShield->GetElement(elem)->GetEnergy();
                    if (elem ==0)
                    {
                        CATSShield_energy_segment1->Fill(value_energy);
                    }
                    if (elem ==1)
                    {
                        CATSShield_energy_segment2->Fill(value_energy);
                    }
                    if (elem ==2)
                    {
                        CATSShield_energy_segment3->Fill(value_energy);
                    }
                    if (elem ==3)
                    {
                        CATSShield_energy_segment4->Fill(value_energy);
                    }
                    if (elem ==4)
                    {
                        CATSShield_energy_segment5->Fill(value_energy);
                    }
                }
            }
        }
...
//        if ((fCATSShield) && (fCATSAnnulus))
        if (fCATSAnnulus)
        {
            ...
            // get element number
                    Int_t elem = fCATSAnnulus->GetRawEnergyHits()[i];
            // get ADC value
                    UShort_t value_adc = fCATSAnnulus->GetElement(elem)->GetRawADCValue();
                    if ((elem == 0) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSAnnulus_NOshield_RawADC_segment1->Fill(value_adc);
                    }
                    if ((elem == 1) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSAnnulus_NOshield_RawADC_segment2->Fill(value_adc);
                    }
                    if ((elem == 2) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSAnnulus_NOshield_RawADC_segment3->Fill(value_adc);
                    }
                    if ((elem == 3) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSAnnulus_NOshield_RawADC_segment4->Fill(value_adc);
                    }
                    if ((elem == 4) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSAnnulus_NOshield_RawADC_segment5->Fill(value_adc);
                    }
                    if ((elem == 5) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSAnnulus_NOshield_RawADC_segment6->Fill(value_adc);
                    }
                }
            }
        }
        
//        if((fCATSShield) && (fCATSCore))
        if (fCATSCore)
        {
            if (fCATSCore->IsRawHits())
            {
            ...
            // get ADC value
                    ...
                    if ((elem == 0) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSCore_NOshield_RawADC_PMT1->Fill(value_adc);
                    }
                    if ((elem == 1) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSCore_NOshield_RawADC_PMT2->Fill(value_adc);
                    }
                    if ((elem == 2) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSCore_NOshield_RawADC_PMT3->Fill(value_adc);
                    }
                    if ((elem == 3) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSCore_NOshield_RawADC_PMT4->Fill(value_adc);
                    }
                    if ((elem == 4) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSCore_NOshield_RawADC_PMT5->Fill(value_adc);
                    }
                    if ((elem == 5) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSCore_NOshield_RawADC_PMT6->Fill(value_adc);
                    }
                    if ((elem == 6) && (fCATSShield->GetNhits() == 0))
                    {
                        CATSCore_NOshield_RawADC_PMT7->Fill(value_adc);
                    }
                }
            }
        }
...
void    TA2GoAT::Finish()
{
    ...
    if(treeCats)
        {
        treeCats->Write();      //Write
        delete treeCats;        // Close and delete in memory
        }
